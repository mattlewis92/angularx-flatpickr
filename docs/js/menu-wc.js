...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">angularx-flatpickr documentation</a>
                </li>
                    ...
                    <li class="chapter modules">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                <li class="link">
                                    <a href="injectables/FlatpickrDefaults.html" data-type="entity-link" >FlatpickrDefaults</a>
                                </li>
                            </ul>
                        </li>
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            <li class="link">
                                <a href="interfaces/FlatPickrDayCreateOutputOptions.html" data-type="entity-link" >FlatPickrDayCreateOutputOptions</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/FlatpickrDefaultsInterface.html" data-type="entity-link" >FlatpickrDefaultsInterface</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/FlatPickrOutputOptions.html" data-type="entity-link" >FlatPickrOutputOptions</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
